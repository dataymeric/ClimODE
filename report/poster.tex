    ...
    \headerbox{\bf\color{blue} Experiments \& Results}{name=results,column=2,row=0,span=3}{
        ...
        \begin{minipage}[t]{0.6\textwidth}
            ...
            \begin{tabular}{lcccccc}
                ...
                VRAM (Gb) & {\cellcolor[HTML]{FFF5EB}} \color[HTML]{000000} 10.20 & {\cellcolor[HTML]{FDC997}} \color[HTML]{000000} 15.70 & {\cellcolor[HTML]{FEECD9}} \color[HTML]{000000} 11.80 & {\cellcolor[HTML]{FDAD69}} \color[HTML]{000000} 17.80 & {\cellcolor[HTML]{FEDDBC}} \color[HTML]{000000} 13.70 & {\cellcolor[HTML]{7F2704}} \color[HTML]{F1F1F1} 30.10 \\
                \hline
            \end{tabular}
        \end{minipage}
    }
